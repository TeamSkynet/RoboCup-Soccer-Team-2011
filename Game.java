...
public class Game {
	...
	public static void main(String args[]) throws Exception
	{
		...
		p1.initPlayer(-5, -27.2, "far_left_fwd");
		Thread.sleep(100);

		p2.initPlayer(-5, -13.6, "left_fwd");
		Thread.sleep(100);

		p3.initPlayer(-5, 13.6, "right_fwd");
		Thread.sleep(100);

		p4.initPlayer(-5, 27.2, "far_right_fwd");
		Thread.sleep(100);

		p5.initPlayer(-15, 0, "center_fwd");
		Thread.sleep(100);

		p6.initFullBack(-22.7, -25, "left_fb");
		Thread.sleep(100);

		p7.initFullBack(-30, 0, "center_fb");
		Thread.sleep(100);

		p8.initFullBack(-22.7, 25, "right_fb");
		Thread.sleep(100);
